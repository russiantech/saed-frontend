...
// // // ── Handle API Errors ─────────────────────────────────────
// // if (!response.ok) {
// //   // Any 403 whose body mentions CSRF invalidates our cached token,
// //   // regardless of which endpoint triggered it — not just login/signup/logout.
// //   if (response.status === 403 && text.toLowerCase().includes("csrf")) {
// //     clearCsrfToken();
// //   }
